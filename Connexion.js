      ...
      connexion=()=>{
        ...
        render() {
          ...
          <div className="inscription">
              ...
              <a className='mdp-oublier' href="https//">Mot de passe oublier ?</a>
              <span className="connexion-lign"></span>
              <h4 className="reinscription">Vous n'avez pas de compte? <a className="sub-title-inscription" href="https//">S'inscrire</a></h4>
            </div>
          </div>
          );
        }
