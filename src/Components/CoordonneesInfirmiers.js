...
class CoordonneesInfirmiers extends Component {
            ...
            <div className="body-coordonnees">
                       ...
                       <div className="cordonnees">
                          <div className="left-cordonnees-item">
                           ...
                           <div className="right-cordonnees-item">
                             ...
                             <select className="input-section option-color" onChange={(event) => this.props.changeGouvernerat(event)} >
                  ...
                  <div className="section">
                    ...
                    <div className="cordonnees">
                      ...
                      <select className="input-section option-color" onChange={(event) => this.props.expérience(event)} >
                  ...
                  <div className="section">
                    ...
                    <div className="cordonnees">
                       <input className="input-section" onChange={(event) => this.props.changePrix(event)} ></input>
    ...
    <label className="confirme"><Link className="choice-item" to='/Components/InfirmierList'>Enregistrer</Link></label>
</div>
